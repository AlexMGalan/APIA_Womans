    ...
    //   db.execSQL("INSERT INTO "  +  TABLE_SYSTEM + "(s_admin) "
      ...
      //  String CREATE_PLAYERS_TABLE = "CREATE TABLE " + TABLE_PLAYERS + "("
       ...
       // db.execSQL(CREATE_PLAYERS_TABLE);
        ...
        db.execSQL("INSERT INTO "  +  TABLE_MATCHES + "(m_round, m_date,m_hometeam,m_visitteam,m_ground,m_time1,m_time2, m_time17, m_time15, m_time14, m_logo, m_lat, m_long, m_address  ) "
                + "VALUES (10, '2018-05-13', 'Gladesville Ravens', 'APIA', 'Christie Park', ' 3:00PM',' 1:35PM', '12:00PM', ' 9:55AM', ' 8:30AM', 'ravens', -33.7706816,151.1168373, '12a Christie Rd, Macquarie Park' )");
        ...
        db.execSQL("INSERT INTO "  +  TABLE_MATCHES + "(m_round, m_date,m_hometeam,m_visitteam,m_ground,m_time1,m_time2, m_time17, m_time15, m_time14, m_logo, m_lat, m_long, m_address  ) "
                + "VALUES (12, '2018-05-27', 'Southern Branch', 'APIA', 'SOUTH NOWRA FOOTBALL COMPLEX', ' 3:00PM',' 1:35PM', '12:00PM', ' 9:55AM', ' 8:30AM', 'westnsw', -34.9003438, 150.604564, 'Mulbulla Street, South Nowra' )");
        ...
        db.execSQL("INSERT INTO "  +  TABLE_MATCHES + "(m_round, m_date,m_hometeam,m_visitteam,m_ground,m_time1,m_time2, m_time17, m_time15, m_time14, m_logo, m_lat, m_long, m_address  ) "
                + "VALUES (14, '2018-06-10', 'Sd Raiders', 'APIA', 'Ernie Smith Reserve', ' 6:00PM',' 4:05PM', ' 2:30PM', '12:55PM', '12:00PM', 'sdraiders', -33.9340737,150.9414135, 'Kelso Crescent Moorebank' )");

        db.execSQL("INSERT INTO "  +  TABLE_MATCHES + "(m_round, m_date,m_hometeam,m_visitteam,m_ground,m_time1,m_time2, m_time17, m_time15, m_time14, m_logo, m_lat, m_long, m_address ) "
                + "VALUES (15, '2018-06-17', 'Western NSW', 'APIA', 'Proctor Park', ' 3:00PM',' 1:35PM', '12:00PM', ' 9:55AM', ' 8:30AM', 'westnsw', -33.4301031,149.5862814, 'Gormans Hill Rd, Bathurst' )");

        db.execSQL("INSERT INTO "  +  TABLE_MATCHES + "(m_round, m_date,m_hometeam,m_visitteam,m_ground,m_time1,m_time2, m_time17, m_time15, m_time14, m_logo, m_lat, m_long, m_address  ) "
                + "VALUES (16, '2018-06-24', 'Sydney Olympic', 'APIA', 'Peter Moore Field', ' 3:00PM',' 1:35PM', ' 12:00PM', ' 9:55AM', '8:30AM', 'sydneyolympic', -33.915913,151.0941328, '1C Leylands Parade, Belmore' )");
        ...
        db.execSQL("INSERT INTO "  +  TABLE_MATCHES + "(m_round, m_date,m_hometeam,m_visitteam,m_ground,m_time1,m_time2, m_time17, m_time15, m_time14, m_logo, m_lat, m_long, m_address  ) "
                + "VALUES (18, '2018-07-08', 'InterLions', 'APIA', 'Concord Oval', ' 3:00PM',' 1:35PM', '12:00PM', ' 9:55AM', ' 8:30AM', 'interlions', -33.8685739,151.1071847, 'Loftus St, Concord' )");
        ...
        db.execSQL("INSERT INTO "  +  TABLE_MATCHES + "(m_round, m_date,m_hometeam,m_visitteam,m_ground,m_time1,m_time2, m_time17, m_time15, m_time14, m_logo, m_lat, m_long, m_address  ) "
                + "VALUES (20, '2018-07-22', 'UNSW', 'APIA', 'David Phillips Field', ' 3:00PM',' 1:35PM', '12:00PM', ' 9:55AM', ' 8:30AM', 'unsw', -33.931135,151.2222627, 'Gwea Avenue Daceyville' )");
        ...
        db.execSQL("INSERT INTO "  +  TABLE_MATCHES + "(m_round, m_date,m_hometeam,m_visitteam,m_ground,m_time1,m_time2, m_time17, m_time15, m_time14, m_logo, m_lat, m_long, m_address  ) "
                + "VALUES (22, '2018-08-05', 'St George', 'APIA', 'St George Stadium', ' 3:00PM',' 1:35PM', '12:00PM', ' 9:55AM', ' 8:30AM', 'stgeorge',-33.9420635,151.1520375, '88 Bestic Street, Rockdale' )");
